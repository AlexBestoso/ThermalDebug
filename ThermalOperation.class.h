...
#define THERMAL_OPERATOR_DIVIDE_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 14
#define THERMAL_OPERATOR_XOR_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 15
#define THERMAL_OPERATOR_OR_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 16
#define THERMAL_OPERATOR_AND_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 17
#define THERMAL_OPERATOR_SHIFT_LEFT_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 18
#define THERMAL_OPERATOR_SHIFT_RIGHT_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 19
#define THERMAL_OPERATOR_MOD_EQUALS THERMAL_OPERATOR_COMBINED_OFFSET + 20
